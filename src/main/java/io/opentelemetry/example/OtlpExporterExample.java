...
public class OtlpExporterExample {
    ...
    private final static Logger logger = LoggerFactory.getLogger(OtlpExporterExample.class);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        OpenTelemetry openTelemetry = OtlpConfiguration.initOpenTelemetry();
        // note: currently metrics is alpha and the configuration story is still
        // unfolding. This will
        // definitely change in the future.
        MeterProvider meterProvider = OtlpConfiguration.initOpenTelemetryMetrics();
        ...
        for (int i = 0; i < 10; i++) {
            ...
            logger.info("TraceID : {}", exampleSpan.getSpanContext().getTraceIdAsHexString());
